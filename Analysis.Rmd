...
global_file_to_process <- "data/raw_data/applemobilitytrends-2021-10-09.csv"
...
```{r plot-time series}
# create a timeseries plot of the mean relative driving mobility across the state
...
# knitted document and save that figure to the output
# figures directory as a png file
tallied_plot <- ggplot(data = long_subset,
                       aes(x = geo_type,
                           y = relative_mobility,
                           fill = transportation_type)) +
  geom_col(position = position_dodge()) +
